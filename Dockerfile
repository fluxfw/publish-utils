...
RUN (mkdir -p /build/flux-publish-utils/libs/flux-autoload-api && cd /build/flux-publish-utils/libs/flux-autoload-api && wget -O - https://github.com/fluxfw/flux-autoload-api/releases/download/v2022-07-12-1/flux-autoload-api-v2022-07-12-1-build.tar.gz | tar -xz --strip-components=1 && /flux-namespace-changer/bin/change-namespace.php . FluxAutoloadApi FluxPublishUtils\\Libs\\FluxAutoloadApi)
