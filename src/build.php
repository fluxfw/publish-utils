...
copy(__DIR__ . "/composer_build_ci.yml", __DIR__ . "/../build/composer_build_ci.yml");
copy(__DIR__ . "/docker_build_ci.yml", __DIR__ . "/../build/docker_build_ci.yml");
copy(__DIR__ . "/npm_build_ci.yml", __DIR__ . "/../build/npm_build_ci.yml");
